      ...
      <div className="row">
        <div className="col-6 center-block text-center">
          <div className="hero-overlay center-block padding-top-xlg text-left padding-bottom-xlg margin-bottom-xlg text-black mobile-center">
            ...
            <p className="margin-top-xsm margin-bottom-none">{Hero.subtitle}</p>
            <div className="desktop-only padding-top-lg margin-bottom-lg text-center">
              <Link
                to="/contact"
                style={{
                  textDecoration: "none"
              ...
              >
                <a href="#" className="btn margin-left-none">
                  {Hero.call}
                </a>
              </Link>
            </div>
        ...
        <div className="col-6 text-center">
          ...
          <div className="mobile-only margin-top-none margin-bottom-xlg margin-left-xlg margin-right-xlg text-center">
            <a href={Hero.href} className="btn">
              {Hero.call}
            </a>
          </div>
